...
<head>
    <meta charset="utf-8">
    <title>Visitor - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">Visitor</h1>
...
<header>
        ...
        Visitor
            ...
            <div class="class-description"><p>Visitor class represents information about current website visitor.</p></div>
...
<article>
    ...
    <h4 class="name" id="Visitor"><span class="type-signature"></span>new Visitor<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="visitor.js.html">visitor.js</a>, <a href="visitor.js.html#line12">line 12</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>UUID is unique identifier for user. UUID for visitor sets automatically on starting.
Managers have UUID in their account.</p></td>
        </tr>
...
<span class="param-type">Array.&lt;Field></span>
            ...
            <td class="description last"><p>custom fiels defined for user</p></td>
        </tr>
...
<div class="description">
    ...
    <h4 class="name" id=".buildFromInfo"><span class="type-signature">(static) </span>buildFromInfo<span class="signature">(data)</span><span class="type-signature"> &rarr; {<a href="Visitor.html">Visitor</a>}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="visitor.js.html">visitor.js</a>, <a href="visitor.js.html#line50">line 50</a>
    </li></ul></dd>
...
<div class="description">
    <p>Static builder for visitor instance</p>
</div>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>Visitor representation received from API</p></td>
        </tr>
...
<span class="param-type"><a href="Visitor.html">Visitor</a></span>
    ...
    <h4 class="name" id="getEmail"><span class="type-signature"></span>getEmail<span class="signature">()</span><span class="type-signature"> &rarr; {string|*}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line64">line 64</a>
    </li></ul></dd>
    ...
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#getEmail">User#getEmail</a>
    </li></ul></dd>
...
<span class="param-type">*</span>
    ...
    <h4 class="name" id="getFields"><span class="type-signature"></span>getFields<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="visitor.js.html">visitor.js</a>, <a href="visitor.js.html#line25">line 25</a>
    </li></ul></dd>
...
<div class="description">
    <p>Gets visitor's custom fields</p>
</div>
    ...
    <h4 class="name" id="getIsOnline"><span class="type-signature"></span>getIsOnline<span class="signature">()</span><span class="type-signature"> &rarr; {boolean}</span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line80">line 80</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#getIsOnline">User#getIsOnline</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#getName">User#getName</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line32">line 32</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#getUuid">User#getUuid</a>
    </li></ul></dd>
...
<span class="param-type">*</span>
    ...
    <h4 class="name" id="setEmail"><span class="type-signature"></span>setEmail<span class="signature">(email)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line56">line 56</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#setEmail">User#setEmail</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="setFields"><span class="type-signature"></span>setFields<span class="signature">(fields)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="visitor.js.html">visitor.js</a>, <a href="visitor.js.html#line33">line 33</a>
    </li></ul></dd>
...
<div class="description">
    <p>Sets custom fields for visitor</p>
</div>
...
<span class="param-type">object</span>
            ...
            <td class="description last"><p>Visitor fields object</p></td>
        </tr>
    ...
    <h4 class="name" id="setIsOnline"><span class="type-signature"></span>setIsOnline<span class="signature">(isOnline)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line72">line 72</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#setIsOnline">User#setIsOnline</a>
    </li></ul></dd>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line40">line 40</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#setName">User#setName</a>
    </li></ul></dd>
...
<span class="param-type">string</span>
    ...
    <h4 class="name" id="setUuid"><span class="type-signature"></span>setUuid<span class="signature">(uuid)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line23">line 23</a>
    </li></ul></dd>
    ...
    <dt class="inherited-from">Inherited From:</dt>
    <dd class="inherited-from"><ul class="dummy"><li>
        <a href="User.html#setUuid">User#setUuid</a>
    </li></ul></dd>
