...
<header>
        ...
        User
            ...
            <div class="class-description"><p>Class User represents conversation member (visitor or manager).</p></div>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="user.js.html">user.js</a>, <a href="user.js.html#line10">line 10</a>
    </li></ul></dd>
    ...
    <dd class="tag-see">
        <ul>
            <li>Visitor for detailed information about visitor</li>
        
            <li>Manager for detailed information about manager</li>
        </ul>
    </dd>
