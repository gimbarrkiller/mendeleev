...
<head>
    <meta charset="utf-8">
    <title>ChatroomMember - Documentation</title>
...
<div id="main">
    ...
    <h1 class="page-title">ChatroomMember</h1>
...
<header>
        ...
        ChatroomMember
            ...
            <div class="class-description"><p>Due to security reasons, we have to hide potentially sensitive data about other visitors from current one.
This class is used to deliver information about chatroom members without riks to sensetive data.</p></div>
...
<article>
    ...
    <h4 class="name" id="ChatroomMember"><span class="type-signature"></span>new ChatroomMember<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="chatroomMember.js.html">chatroomMember.js</a>, <a href="chatroomMember.js.html#line1">line 1</a>
    </li></ul></dd>
